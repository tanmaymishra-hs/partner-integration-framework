     ...
     <ErrorBoundary>
      ...
      <div className="container">
        {config && <Routes>
          ...
          <Route exact path="/admin/create-partner/test" element={<Index key="CreatePartner" config = {config["config"]["apis"]["create"]} iAuthToken={config['config']['apis']['create']['category']==="admin"?iAuthToken:null}/>}></Route>
          <Route exact path="/admin/delete-partner/test" element={<Index key="DeletePartner" config = {config["config"]["apis"]["deletePartner"]} iAuthToken={config['config']['apis']['deletePartner']['category']==="admin"?iAuthToken:null}/>}></Route>
          <Route exact path="/admin/get-partner/test" element={<Index key="GetPartner" config = {config["config"]["apis"]["getPartner"]} iAuthToken={config['config']['apis']['getPartner']['category']==="admin"?iAuthToken:null}/>}></Route>
          <Route exact path="/admin/list-partner/test" element={<Index key="ListPartner" config = {config["config"]["apis"]["listPartners"]} iAuthToken={config['config']['apis']['listPartners']['category']==="admin"?iAuthToken:null}/>}></Route>
          <Route exact path="/admin/update-partner/test" element={<Index key="UpdatePartner" config = {config["config"]["apis"]["updatePartner"]} iAuthToken={config['config']['apis']['updatePartner']['category']==="admin"?iAuthToken:null}/>}></Route>
