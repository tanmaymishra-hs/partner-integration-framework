...
export default function Input(props) {
    ...
    <div>
        ...
        {typeof props.placeholder !== "object"? 
            ...
            <textarea style={{'display':'inline-block', 'position':'absolute'}} value={value} placeholder={JSON.stringify(props.placeholder)} onChange={handleOnChange} rows={8} cols={40}>{value}</textarea>
        }
    </div>
    )
}
