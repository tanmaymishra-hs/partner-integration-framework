...
import {updateUserDetailsSync} from '../../../../utils/UpdateUserDetailsSync'
...
export function Index() {
    ...
    const handleSubmit = async (event, setisLoading)=>{
      ...
      let partner_global_token = updateUserDetailsSync(values["RequestBody"], secretKey)
      ...
      try{
       ...
       const response = await fetch(`http://localhost:8080/v2/partner/subscription/user/update`, {
        method: 'POST',
        headers,
